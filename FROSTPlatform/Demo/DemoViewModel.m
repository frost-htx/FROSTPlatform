...
//    [requestAPI start];
    ...
    NSDictionary * dic = @{@"UserAgent":@"ZZCIOS/com.tantu.map/1.3.6 (iPhone; CPU iPhone OS 10_2 like Mac OS X) AppleWebKit/602.3.12 (KHTML, like Gecko) Mobile/14C89 MUID/LzWIuIqPWNEApZdPl8Wg7rRyD23+EYNAPZnHTJbkOxJx8nibqDIWYifbor3QThmh"};
    
//    [BaseService getDataWithUrlPath:@"http://m.zuzuche.com/api/poi/get_message_zip.php" params:nil customHTTPHead:dic successfulBlock:^(NSURLSessionDataTask *dataTask, id responseObject) {
//        
